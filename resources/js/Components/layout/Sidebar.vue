                    ...
                    <ul class="relative font-semibold space-y-0.5 p-4 py-0">
                        ...
                        <li class="menu nav-item">
                            <button
                                type="button"
                                class="nav-link group w-full"
                                :class="{ active: activeDropdown === 'Masters' }"
                                @click="activeDropdown === 'Masters' ? (activeDropdown = null) : (activeDropdown = 'Masters')"
                            >
                                <div class="flex items-center">
                                    <svg
                                        class="group-hover:!text-primary shrink-0"
                                    ...
                                    <span class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Masters</span>
                                </div>
                                <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === 'Masters' }">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M9 5L15 12L9 19"
                                            stroke="currentColor"
                            ...
                            <vue-collapsible :isOpen="activeDropdown === 'Masters'">
                                <ul class="sub-menu text-gray-500">
                                    <li>
                                        <a href="/posts" @click="toggleMobileMenu">Posts</a>
                                    </li>
                                </ul>
                            </vue-collapsible>
                        </li>
